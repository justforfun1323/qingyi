...
struct Date::YearMonthDay GetYearMonthDay(int julian_day_number) {
...
Date::Date(const struct tm& t) 
   : julian_day_number_(
    GetJuliandaynumber(t.tm_year + 1900,
                       t.tm_mon + 1,
                       t.tm_mday)) {
